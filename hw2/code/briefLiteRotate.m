function [locs, Desc] = briefLiteRotate(im,RotationInterval)
% input
...
[locs,Desc] = computeBriefRotate(im, GaussianPyramid, locsDoG, k, levels, compareA, compareB,patchWidth,RotationInterval);
%end
